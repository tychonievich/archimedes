...
<html><head>
    ...
    <script src="codebox_c.js"></script>
...
function grader_fb($details) {
    echo '<div class="hide-outer"><strong class="hide-header">staff feedback</strong><div class="hide-inner">';
...
if ($submittable) {
    ...
    if ($class == 'late')
        echo ", though if you do you will be subject to any late penalty that applies per course policies";
